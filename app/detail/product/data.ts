...
const VENDORS: Record<string, VendorInfo> = {
  ...
  'martabak-go-99': {
    id: 'martabak-go-99',
    name: 'Martabak Go 99',
    avatar: 'https://images.pexels.com/photos/37129828/pexels-photo-37129828.jpeg',
    rating: 4.8,
    isRescuePartner: true,
  },
  'bakso-si-gendut': {
    ...
    avatar: 'https://images.pexels.com/photos/35398717/pexels-photo-35398717.jpeg',
    rating: 4.9,
    isRescuePartner: false,
  },
  'ketoprak-sedap-siang': {
    id: 'ketoprak-sedap-siang',
    name: 'Ketoprak Sedap Siang',
    avatar: 'https://images.pexels.com/photos/29831531/pexels-photo-29831531.jpeg',
    rating: 4.6,
    isRescuePartner: true,
  },
};
...
export const PRODUCTS: Record<string, ProductDetail> = {
  ...
  'nasi-goreng-gila': {
    ...
    category: 'Makanan Berat',
    vendor: VENDORS['nasi-goreng-mas-jono'],
    ...
    description: 'Nasi goreng spesial dengan topping lengkap: sosis, bakso, telur, dan sayuran. Racikan bumbu khas Mas Jono yang bikin nagih.',
  ...
  'martabak-coklat-kacang': {
    ...
    description: 'Martabak manis tipis dengan taburan coklat meses dan kacang yang melimpah. Dibuat segar setiap sore oleh Martabak Go 99.',
  ...
  'bakso-komplit': {
    ...
    slug: 'bakso-komplit',
    category: 'Makanan Berat',
    vendor: VENDORS['bakso-si-gendut'],
    title: 'Bakso Komplit',
  ...
  'ketoprak-telor': {
    ...
    slug: 'ketoprak-telor',
    category: 'Makanan Berat',
    vendor: VENDORS['ketoprak-sedap-siang'],
