      ...
      >
        <div className="flex flex-wrap items-end justify-between gap-3">
          ...
          <Link
            ...
            className="inline-flex shrink-0 items-center gap-1.5 rounded-full border border-green-700 px-4 py-2 text-xs font-semibold text-green-700 transition-colors hover:bg-green-700/10"
          >
