  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#F7F5EF] px-6">
      <div className="w-full max-w-sm text-center">
        <h1 className="font-display text-2xl font-semibold tracking-tight text-[#3B5240]">
          Login Pembeli
        </h1>
        ...
        <Link
          href="/login"
          className="mt-6 inline-block font-sans text-sm font-semibold text-[#3B5240] underline underline-offset-4"
        >
