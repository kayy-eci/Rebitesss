...
export function MonthlySalesTargetCard() {
  ...
  return (
    <Card>
      <div className="flex items-center justify-between gap-2">
        <h2 className="text-sm font-bold text-charcoal-900">Target Penjualan Bulanan</h2>
        <button
          type="button"
          aria-label="Edit target penjualan"
      ...
      <div className="mt-2 flex items-center justify-between text-xs">
        <p className="font-semibold text-charcoal-900">
          {CURRENT} porsi <span className="font-normal text-sage-500">terjual</span>
        </p>
      ...
      <p className="mt-3 rounded-xl bg-cream-50 px-3 py-2 text-[11px] leading-relaxed text-charcoal-500">
        Tinggal {TARGET - CURRENT} porsi lagi untuk mencapai target bulan ini. Pertahankan
        ritme penjualanmu!
      </p>
    </Card>
  );
