...
const SpecularButton = ({
  ...
  const btnRef = useRef<HTMLButtonElement | HTMLSpanElement | HTMLDivElement>(
    null,
  );
  ...
  const btnClassName = `specular-button specular-button--${size}${
    className ? ` ${className}` : ""
  }`;
  const btnStyle = {
    "--sb-radius": `${radius}px`,
  ...
  return (
    <Tag
      ref={btnRef as RefObject<HTMLSpanElement & HTMLDivElement>}
      className={btnClassName}
      style={btnStyle}
    >
      {content}
