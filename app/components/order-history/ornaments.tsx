  ...
  return (
    ...
    >
      ...
      <g transform="translate(96 100)">
        <path d="M8 2C3-3-2-3-5-1c0 3 3 5 8 5Z" fill="hsl(var(--primary) / 0.6)" />
        <path d="M8 2c4-5 9-5 12-3 0 3-3 5-8 5Z" fill="hsl(var(--primary))" />
        <circle cx="8" cy="14" r="13" fill="hsl(var(--caramel))" opacity="0.9" />
        <ellipse
          cx="4"
          cy="10"
          rx="3.5"
      ...
      <path
        ...
        opacity="0.8"
      />
      <path d="M130 98c2-9 9-14 18-13-1 8-8 14-18 13Z" fill="hsl(var(--primary) / 0.6)" />
      ...
      <g transform="translate(150 78)">
        <rect
          ...
          strokeWidth="2"
        />
        <rect x="10" y="2" width="28" height="10" rx="5" fill="hsl(var(--primary))" />
        <rect x="12" y="10" width="24" height="4" fill="hsl(var(--primary))" />
        <path
          d="M8 20h32M8 28h20"
          stroke="hsl(var(--primary) / 0.6)"
          strokeWidth="2.4"
      ...
      <g transform="translate(190 104)">
        ...
        <path
          ...
          strokeLinecap="round"
        />
        <path d="M14 12c-1-5-5-8-10-8 0 5 4 8 10 8Z" fill="hsl(var(--primary))" />
        <path d="M14 14c1-5 5-8 9-7-1 5-5 8-9 7Z" fill="hsl(var(--primary) / 0.6)" />
      </g>
    </svg>
  );
}
...
export function BowlThumb({ className }: OrnamentProps) {
  return (
    ...
    >
      <rect x="4" y="4" width="56" height="56" rx="18" fill="hsl(var(--secondary))" />
      <path
...
export function BakeryThumb({ className }: OrnamentProps) {
  return (
    ...
    >
      <rect x="4" y="4" width="56" height="56" rx="18" fill="hsl(var(--secondary))" />
      <path d="M32 20c8 0 14 6 14 14H18c0-8 6-14 14-14Z" fill="hsl(var(--secondary))" />
      <path
      ...
      <path
        ...
        opacity="0.7"
      />
      <circle cx="32" cy="46" r="8" fill="hsl(var(--primary))" opacity="0.9" />
      <circle cx="28" cy="43" r="2" fill="hsl(var(--primary))" />
      <circle cx="35" cy="48" r="1.6" fill="hsl(var(--primary) / 0.6)" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        strokeWidth="2"
      />
      <rect x="20" y="22" width="24" height="10" rx="3" fill="hsl(var(--primary))" />
      <circle cx="30" cy="40" r="4" fill="hsl(var(--caramel))" opacity="0.85" />
      <circle cx="40" cy="42" r="3" fill="hsl(var(--primary))" />
      <path
