...
export default function ReBitesStepCard({
  ...
  return (
    <div
      className={`relative flex h-[400px] cursor-pointer flex-col overflow-hidden rounded-2xl border border-black/5 shadow-sm transition-[box-shadow,background-color] duration-300 ${
    ...
    >
      ...
      <div className="mt-auto flex flex-col px-6 pb-6 pt-4">
        <span className="flex h-9 w-9 items-center justify-center rounded-lg border border-black/5 bg-white text-[#005A46]">
