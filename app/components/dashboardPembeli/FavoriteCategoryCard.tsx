...
import { favoriteCategoriesByMonth, monthOptions } from './data';
...
export function FavoriteCategoryCard() {
  ...
  const data = favoriteCategoriesByMonth[month];
    ...
    <Card>
      <div className="flex flex-wrap items-start justify-between gap-2">
        ...
        <FilterDropdown
          ...
          ariaLabel="Pilih bulan untuk kategori favorit"
        />
      </div>
      ...
      <div
        ...
        role="img"
        aria-label="Persentase belanja per kategori"
      >
