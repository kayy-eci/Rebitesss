...
import { ArrowRight, Bell, Menu, Search, Settings } from 'lucide-react';
      ...
      <div className="mx-auto flex max-w-[1400px] items-center gap-3 px-4 py-3 sm:px-6 lg:px-10">
        ...
        <div className="relative hidden max-w-md flex-1 sm:block">
          ...
          <input
            ...
            aria-label="Cari makanan surplus di sekitarmu"
        ...
        <div className="hidden items-center gap-2.5 md:flex">
          <div className="relative h-10 w-10 overflow-hidden rounded-full ring-2 ring-sage-100">
            <SmartImage src={BUYER.avatar} alt="Foto profil Sarah Wijaya" />
          </div>
          <div className="leading-tight">
            <p className="text-sm font-semibold text-charcoal-900">{BUYER.name}</p>
            <p className="text-[11px] text-sage-500">{BUYER.tier}</p>
          </div>
        </div>

        <Link
          href="/"
          aria-label="Jelajahi makanan"
        ...
        >
          <span className="hidden md:inline">Jelajahi Makanan</span>
